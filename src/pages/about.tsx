...
const AboutPage = () => (
    <Layout pageTitle="About Me">
        ...
        <p>
            I love creating web applications and I'm always looking for new things to learn to improve my knowledge and skills. You will find on my site, some of creations.
        </p>
        <p>
